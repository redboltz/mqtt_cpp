...
BOOST_AUTO_TEST_CASE( pub_qos1_sub_qos1 ) {
    auto test = [](boost::asio::io_service& ios, auto& c, auto& s, auto& /*b*/) {
        ...
        mqtt::optional<packet_id_t> recv_packet_id;
        c->set_pub_res_sent_handler(
            [&chk, &recv_packet_id]
            (packet_id_t packet_id) {
                ...
                for (auto const& p : props) {
                    mqtt::visit(
                        mqtt::make_lambda_visitor<void>(
                            ...
                            [&](mqtt::v5::property::content_type const& t) {
    ...
    auto test = [](boost::asio::io_service& ios, auto& c, auto& s, auto& b) {
        ...
        c->set_v5_pubrec_handler(
            ...
            (packet_id_t packet_id, std::uint8_t, std::vector<mqtt::v5::property_variant> props) {
                ...
                c->pubrel(packet_id, mqtt::v5::reason_code::success, std::move(pubrelps));
        ...
        c->set_v5_publish_handler(
            ...
            (std::uint8_t header,
             ...
             std::vector<mqtt::v5::property_variant> /*props*/) {
                ...
                BOOST_TEST(topic == "topic1");
                BOOST_TEST(contents == "topic1_contents");
                c->pubrec(*packet_id, mqtt::v5::reason_code::success, {});
                return true;
            });
        c->set_v5_pubrel_handler(
            [&c]
            (packet_id_t packet_id, std::uint8_t, std::vector<mqtt::v5::property_variant> /*props*/) {
                c->pubcomp(packet_id, mqtt::v5::reason_code::success, {});
                return true;
            });
        c->set_close_handler(
            [&chk, &s]
