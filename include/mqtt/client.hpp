...
public:
     ...
     */
    friend std::shared_ptr<callable_overlay<client<tcp_endpoint<as::ip::tcp::socket,
     ...
     */
    friend std::shared_ptr<callable_overlay<client<ws_endpoint<as::ip::tcp::socket,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
     ...
     * @return client object
     */
    friend std::shared_ptr<callable_overlay<client<tcp_endpoint<tls::stream<as::ip::tcp::socket>,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
     ...
     *  strand is controlled by ws_endpoint, not endpoint, so client has null_strand template argument.
     */
    friend std::shared_ptr<callable_overlay<client<ws_endpoint<tls::stream<as::ip::tcp::socket>,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
inline std::shared_ptr<callable_overlay<client<tcp_endpoint<as::ip::tcp::socket,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
make_client(as::io_context& ioc, std::string host, std::string port, protocol_version version = protocol_version::v3_1_1) {
    using client_t = client<tcp_endpoint<as::ip::tcp::socket,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
inline std::shared_ptr<callable_overlay<client<ws_endpoint<as::ip::tcp::socket,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
make_client_ws(as::io_context& ioc, std::string host, std::string port, std::string path = "/", protocol_version version = protocol_version::v3_1_1) {
    using client_t = client<ws_endpoint<as::ip::tcp::socket,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
inline std::shared_ptr<callable_overlay<client<tcp_endpoint<tls::stream<as::ip::tcp::socket>,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
make_tls_client(as::io_context& ioc, std::string host, std::string port, protocol_version version = protocol_version::v3_1_1) {
    using client_t = client<tcp_endpoint<tls::stream<as::ip::tcp::socket>,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
inline std::shared_ptr<callable_overlay<client<ws_endpoint<tls::stream<as::ip::tcp::socket>,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
...
make_tls_client_ws(as::io_context& ioc, std::string host, std::string port, std::string path = "/", protocol_version version = protocol_version::v3_1_1) {
    using client_t = client<ws_endpoint<tls::stream<as::ip::tcp::socket>,
#if defined(MQTT_NO_TS_EXECUTORS)
    as::strand<as::io_context::executor_type>
#else
    as::io_context::strand
