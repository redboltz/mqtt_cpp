...
MQTT_NS::optional<property_variant> parse_one(buffer& buf) {
    ...
    try {
        ...
        case id::subscription_identifier: {
            ...
            if (consumed == 0) return MQTT_NS::nullopt;
