            ...
            ep.set_publish_handler(
                ...
                (std::uint8_t header,
                 ...
                 mqtt::buffer contents){
                    ...
                    auto r = idx.equal_range(std::string(topic_name)); // TODO: Fix the need to construct a string.
                ...
                (packet_id_t packet_id,
                 std::vector<std::tuple<mqtt::buffer, std::uint8_t>> entries) {
                    ...
                    for (auto const& e : entries) {
                        ...
                        subs.emplace(std::string(topic), ep.shared_from_this(), qos); // TODO Fix need to construct string.
                    }
